(function () {
    angular
        .module("PAF")          
        .controller("EventUpcomingCtrl", EventUpcomingCtrl);    

    EventUpcomingCtrl.$inject = [ 'user', 'EventService', 'ModelService' ];

    function EventUpcomingCtrl(user, EventService, ModelService) {
        ...
        function search() {
            ...
            EventService.retrieveEvent("-1", vm.page)
