(function () {
    angular
        .module("PAF")          
        .controller("EditUserSkillsCtrl", EditUserSkillsCtrl);    

    EditUserSkillsCtrl.$inject = [ 'user', 'UserService' ];

    function EditUserSkillsCtrl(user, UserService) {
