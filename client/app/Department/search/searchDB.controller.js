(function() {
  ...
  function SearchDBCtrl(DeptService) {
    ...
    // The search function searches for departments that matches query string entered by user. 
    // The query string is matched against the department name and department number alike.
